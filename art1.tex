...
\section[Título Artículo\\{\footnotesize \textit{Autor Uno, Autor Dos}}]{Título Artículo}

\begin{center}
\textbf{Autor Uno$^1$, Autor Dos$^2$} \\
Institución Uno$^1$ \\Ciudad, País\\
Institución Dos$^2$\\Ciudad, País\\
autor1@correo.com, autor2@correo.com
\end{center}
...
\bibitem{referencia} Apellido, N. (año). % Por favor usar formato APA
\newblock {\em Título.}
\newblock Ciudad:
\newblock Editorial
\end{thebibliography}
